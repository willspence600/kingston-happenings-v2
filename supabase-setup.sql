...
CREATE TABLE public.profiles (
  ...
  -- Supabase Auth tables live in the `auth` schema; adding a cross-schema FK
  -- causes Prisma migration/introspection issues unless Prisma multi-schema is enabled.
  -- We rely on the signup trigger + admin deletion flow to keep data consistent.
  id UUID PRIMARY KEY,
